...
def main():
    folder_src = r"E:\Code\Dataset\EEG\(4) The largest SCP data of Motor-Imagery"
    folder_dest = r"(4) The largest SCP data of Motor-Imagery"
    ...
    for file in tqdm(file_list, total=len(file_list), desc="正在处理数据集4"):
        ...
        sampling_rate = data['sampFreq'][0][0][0][0]
        ...
        utils.save_parquet(df, os.path.join(folder_dest, f"04_{person:02d}_{trial_mapping[trial_type]}_{sampling_rate}.parquet"))
